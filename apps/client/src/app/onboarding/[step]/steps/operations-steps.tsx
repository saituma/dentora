  ...
  return (
    <Card className="border bg-card/95 shadow-sm rounded-3xl">
      <CardHeader>
        ...
        <CardDescription>
          Select one Twilio number for this clinic. You can change it later from settings.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <FieldGroup>
          ...
          <Field>
            ...
            {hasIncomingNumbers ? (
              ...
              <p className="text-sm text-muted-foreground">
                No purchased Twilio numbers found in this account yet.
              </p>
            )}
          </Field>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button
              className="min-w-40"
              disabled={
                !flow.selectedPhoneNumber || !hasIncomingNumbers || flow.assigningPhoneNumber
              }
              onClick={async () => {
                try {
              ...
              <Button
                ...
                onClick={async () => {
                  const confirmed = window.confirm(
                    'Remove Google Calendar connection? This will stop live booking until reconnected.',
                  );
                  if (!confirmed) return;
                  try {
  ...
  return (
    <Card className="border bg-card/95 shadow-sm rounded-3xl">
      <CardHeader>
        ...
        <CardDescription>
          Set the actual days, opening hours, and break times your AI receptionist must respect when
        ...
        <div className="space-y-5">
          <div className="rounded-lg border bg-muted/20 p-4">
            <div className="mb-4">
              ...
              <p className="text-sm text-muted-foreground">
                Turn days on or off, then set opening and closing times. Add one break window per
                day for lunch or staff-only time.
              </p>
            </div>
                        ...
                        <Field>
                          ...
                          <Input
                            ...
                            onChange={(event) =>
                              flow.setSchedule((prev) => ({
                                ...prev,
                                [day.key]: { ...prev[day.key], start: event.target.value },
                              }))
                            }
                          />
                        </Field>
                        <Field>
                          ...
                          <Input
                            ...
                            onChange={(event) =>
                              flow.setSchedule((prev) => ({
                                ...prev,
                                [day.key]: { ...prev[day.key], end: event.target.value },
                              }))
                            }
                          />
                        </Field>
                        <Field>
                          ...
                          <Input
                            ...
                            onChange={(event) =>
                              flow.setSchedule((prev) => ({
                                ...prev,
                                [day.key]: { ...prev[day.key], breakStart: event.target.value },
                              }))
                            }
                          />
                        </Field>
                        <Field>
                          ...
                          <Input
                            ...
                            onChange={(event) =>
                              flow.setSchedule((prev) => ({
                                ...prev,
                                [day.key]: { ...prev[day.key], breakEnd: event.target.value },
                              }))
                            }
                          />
                        </Field>
                    ...
                    <label className="mt-3 flex items-center gap-3 text-sm text-muted-foreground">
                      <input
                        ...
                        onChange={(event) =>
                          flow.setSchedule((prev) => ({
                            ...prev,
                            [day.key]: { ...prev[day.key], hasBreak: event.target.checked },
                          }))
                        }
                      />
          ...
          <Field>
            ...
            <Textarea
              rows={4}
              value={flow.closedDatesText}
              onChange={(event) => flow.setClosedDatesText(event.target.value)}
              placeholder={'2026-12-25\n2026-12-26'}
            />
            <p className="mt-2 text-sm text-muted-foreground">
              Add one `YYYY-MM-DD` date per line for holidays, training days, or any one-off
              closures.
            </p>
          </Field>
