...
export function DashboardHeader() {
  ...
  return (
    <header className="flex h-14 shrink-0 items-center gap-2 border-b border-black/[0.06] bg-white/80 px-4 backdrop-blur-xl transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 lg:px-6">
