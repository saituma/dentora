      ...
      <SheetViewport side={side} variant={variant}>
        <SheetPrimitive.Popup
          className={cn(
            ...
            side === "left" &&
              "w-[calc(100%-(--spacing(12)))] max-w-md border-e data-ending-style:-translate-x-8 rtl:data-ending-style:translate-x-8 data-starting-style:-translate-x-8 rtl:data-starting-style:translate-x-8",
            side === "right" &&
