...
export function RoiCalculator() {
  ...
  return (
    <section id="roi-calculator" className="relative isolate scroll-mt-24 px-6 py-24 lg:px-8">
      ...
      <div
        ref={ref}
        className="mx-auto mt-12 grid max-w-7xl items-stretch gap-6 lg:grid-cols-[1fr_1.05fr]"
      >
        {/* left: inputs */}
        <motion.div {...inView} className="h-full">
          <div className="mk-panel flex h-full flex-col rounded-3xl p-6 sm:p-8">
        ...
        <motion.div
          ...
          className="h-full"
        >
          <div className="mk-panel relative flex h-full flex-col justify-center overflow-hidden rounded-3xl p-6 text-center sm:p-8 lg:text-left">
            ...
            <div className="relative">
              ...
              <div className="flex flex-col items-center gap-3 sm:flex-row sm:items-center sm:justify-between lg:items-center">
                <p className="text-sm mk-muted">Ready to capture it? Get set up in minutes.</p>
                <Link
                  href="/signup"
