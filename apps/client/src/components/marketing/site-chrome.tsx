...
export function BrandLogo() {
  return (
    <Link href="/" aria-label="Dentora — Home" className="group flex items-center gap-2.5">
      <span className="relative flex size-10 shrink-0 items-center justify-center overflow-hidden rounded-full ring-1 ring-[var(--mk-surface-border)] shadow-sm transition-transform duration-300 group-hover:scale-105">
        <Image
          src="/dentora.png"
          alt="Dentora"
          width={678}
