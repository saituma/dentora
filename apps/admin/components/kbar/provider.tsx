...
export function KBarProvider({ children }: { children: React.ReactNode }) {
  ...
  const actions: Action[] = [
    ...
    },
    {
      ...
      name: "Analytics",
      shortcut: ["g", "n"],
      keywords: "analytics insights sentiment intents booking",
      section: "Navigation",
    ...
    },
    {
      ...
      name: "Cost & Billing",
      shortcut: ["g", "b"],
      keywords: "cost billing spend revenue providers",
      section: "Navigation",
      perform: () => router.push("/cost"),
    },
    {
      id: "system",
      name: "System Health",
      shortcut: ["g", "h"],
      keywords: "system health breakers queues providers ops",
      section: "Operations",
      perform: () => router.push("/system"),
    },
    {
      id: "phone-pool",
      name: "Phone Pool",
      shortcut: ["g", "p"],
      keywords: "phone numbers twilio pool inventory",
      section: "Operations",
      perform: () => router.push("/phone-pool"),
    },
    {
      id: "audit",
      name: "Audit Log",
