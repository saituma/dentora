        ...
        <div className="mt-2">
          {isLoading ? (
            ...
            <input
              ...
              className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-primary/20 transition"
            />
          )}
        </div>
      </div>
